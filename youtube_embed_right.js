                ...
                .done(function(data) {
                    ...
                    if (embeddable === true) {
                        dom =
                            ...
                            '<h4>Video Description/Context Heading Here</h4>' +
                            '<p>Description/context goes here</p>'
                            '</div>' +
                            '<div class="col" style="padding: 10px">\n' +
                            '    <h4 class="text-danger text-center"><i class="fa fa-play-circle-o"></i> ' + title + ' (' + duration_str + ')</h4>\n' +
                            desc +
